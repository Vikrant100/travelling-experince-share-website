...
APP_NAME = 'First-One'   # Add

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '^p@2+cwg)h45v%g7ib#71u$q(t!^a+10x7mh&^_tc1p&!ke7(m'
...
INSTALLED_APPS = [
    ...
    'createexp.apps.CreateexpConfig',
...
"""DATABASES = {
    'default': {
        ...
        'NAME': 'vikrantsingh$ads',
        'USER': 'vikrantsingh',
        'PASSWORD': 'Vikrant1@',
        'HOST': 'vikrantsingh.mysql.pythonanywhere-services.com',
         'OPTIONS': {
